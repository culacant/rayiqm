...
// animated meshes
#define NAMELEN 32
#define ANIMJOINTNAME "ANIMJOINT"
...
// animated meshes
RLAPI void rlLoadAnimatedMesh(AnimatedMesh *amesh, bool dynamic);                         // Upload vertex data into GPU and provided VAO/VBO ids
RLAPI void rlDrawAnimatedMesh(AnimatedMesh amesh, Material material, Matrix transform);    // Draw a 3d mesh with material and transform
RLAPI void rlUnloadAnimatedMesh(AnimatedMesh *amesh);                                      // Unload mesh data from CPU and GPU
RLAPI void rlUpdateAnimatedMesh(AnimatedMesh *amesh);
#ifdef __cplusplus
}
#endif
#endif // RLGL_H
